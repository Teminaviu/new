...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    morestartsAuthUserSubject.add(
      MorestartsAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MorestartsAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MorestartsAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MorestartsAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    morestartsAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
MorestartsAuthUser? currentUser;
